...
namespace WizMes_SeongBinFood
{
    ...
    public partial class Win_mtr_Outware_Q : UserControl
    {
        ...
        private void FillGrid()
        {
            ...
            // 입고량, 입고건수 - 합계 구하기
            //var SumOutware = new Win_mtr_Outware_Sum();
                ...
                else
                {
                    ...
                    foreach (DataRow item in drc)
                    {
                        ...
                        if (item["Depth"].ToString() == "6")            // 총 합 계
                        {
                            ...
                            //SumOutware.SumOutwareQty += ConvertDouble(Window_SubulOutwareViewInsert.OutQty);

                            //dgdOutware.Items.Add(Window_SubulOutwareViewInsert);
                        }

                        //SumOutware.SumOutwareCount = i;
                        //dgdTotal.Items.Add(SumOutware); 
    ...
    class Win_mtr_Outware_Sum : BaseView
    {
        public double SumOutwareQty { get; set; }
        public double SumOutwareCount { get; set; }
    }
