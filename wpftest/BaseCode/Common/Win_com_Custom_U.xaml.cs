...
namespace WizMes_SeongBinFood
{
    ...
    public partial class Win_com_Custom_U : UserControl
    {
        ...
        private void SetComboBox()
        {
            ...
            //물류구분
            ObservableCollection<CodeView> ovcDvlyGbn = ComboBoxUtil.Instance.Gf_DB_CM_GetComCodeDataset(null, "DVLYGBN", "Y", "");
            this.cboDvly.ItemsSource = ovcDvlyGbn;
            this.cboDvly.DisplayMemberPath = "code_name";
            this.cboDvly.SelectedValuePath = "code_id";

            //지역구분
            ObservableCollection<CodeView> ovcAreaGu = ComboBoxUtil.Instance.Gf_DB_CM_GetComCodeDataset(null, "AREAGU", "Y", "");
            this.cboAreaGu.ItemsSource = ovcAreaGu;
            this.cboAreaGu.DisplayMemberPath = "code_name";
            this.cboAreaGu.SelectedValuePath = "code_id";
                    ...
                    else
                    {
                        ...
                        foreach (DataRow dr in drc)
                        {
                            ...
                            var WinCustom = new Win_com_Custom_U_CodeView()
                            {
                                ...
                                AreaGu = dr["AreaGu"].ToString(),
                                DvlyGbn = dr["DvlyGbn"].ToString(),
                            };
        ...
        private bool SaveData(string strCustomID, string strFlag)
        {
            ...
            try
            {
                if (CheckData())
                {
                    ...
                    //sqlParameter.Add("DvlyGbn", cboDvly.SelectedValue.ToString());
                    sqlParameter.Add("DvlyGbn", cboDvly.SelectedValue != null ? cboDvly.SelectedValue.ToString() : "");
                    sqlParameter.Add("AreaGu", cboAreaGu.SelectedValue != null ? cboAreaGu.SelectedValue.ToString() : "");

                    //sqlParameter.Add("AreaGu", cboAreaGu.SelectedValue.ToString());
    ...
    class Win_com_Custom_U_CodeView : BaseView
    {
        ...
        public string AreaGu { get; set; }
        public string DvlyGbn { get; set; }
