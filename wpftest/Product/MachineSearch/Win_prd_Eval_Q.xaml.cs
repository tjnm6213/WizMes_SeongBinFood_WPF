...
namespace WizMes_SeongBinFood
{
    ...
    public partial class Win_prd_Eval_Q : UserControl
    {
        ...
        private void btnMCEvalBasis_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Type type = Type.GetType("WizMes_SeongBinFood." + MainWindow.mMenulist[k].ProgramID.Trim(), true);
                object uie = Activator.CreateInstance(type);

                MainWindow.mMenulist[k].subProgramID = new MdiChild()
                {
                    Title = "WizMes_SeongBinFood [" + MainWindow.mMenulist[k].MenuID.Trim() + "] " + MainWindow.mMenulist[k].Menu.Trim() + 
